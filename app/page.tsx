...
function pageSrc(page: number) {
  if (page === 1) return `${BASE_PATH}/pages/page.png`;
  if (page === 12) return `${BASE_PATH}/pages/page12_overlay-base.png`;
  return `${BASE_PATH}/pages/page${page}.png`;
}
  ...
  return (
    <div className={`vellum ${reverse ? "vellum-reverse" : ""}`}>
      ...
      <img
        ...
        draggable={false}
        src={`${BASE_PATH}/pages/page12-1_overlay-ink.png`}
      />
    </div>
  );
}
